...
<body>
	...
	<!-- End of common part -->
	<br><br>
	<div style="font-size: 35px; font-family: freestyle-script; position: relative; left: 10%;">
		Welcome 
		<?php
		...
		Contact :	<?php echo"$_SESSION[contact]"; ?> <br>
		Gender :	<?php echo"$_SESSION[gender]"; ?> <br>
		Blood Group :	<?php echo"$_SESSION[blood_group] $_SESSION[rh_factor]"; ?> <br>
	...
	<div style="font-size: 35px; font-family: freestyle-script; position: relative; left: 10%;">
		...
		<legend> Your Previous Appointments </legend><br>
		<?php
			...
			if ($result->num_rows > 0) {
    			// output data of each row
    				while($row = $result->fetch_assoc()) {
    					echo'<div style="font-style: italic;"> Appointment ';
    					echo $i;
    					echo '</div>';
    					echo'<br>';
				...
				echo "You have no previous appointments";
			}
	...
	<?php
		...
		$sql = "SELECT first_name FROM patient WHERE username = $_SESSION[uname]";
		*/
