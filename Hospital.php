...
<body>
	...
	<div id="aboutustext">
			...
			<center>
			<span>
				<a href="http://localhost/Hospital%20Website/aboutus.php"><button style="font-size: 30px; padding: 5px; border-radius: 20px; width: 500px; background-color: rgba(230,230,230,0.5); background-repeat: no-repeat; cursor: pointer; border: none; overflow: hidden; outline: none"> Why GWH? </button></a><br>
				<a href="http://localhost/Hospital%20Website/aboutus.php"><button style="position: relative;top: -10px;left: 10px;font-size: 30px; padding: 5px; border-radius: 20px; width: 500px; background-color: rgba(230,230,230,0.5); background-repeat: no-repeat; cursor: pointer; border: none; overflow: hidden; outline: none"> Chairperson's Message </button> </a><br>
				<a href="http://localhost/Hospital%20Website/aboutus.php"><button style="position: relative;top: 30px;left: 0px;font-size: 30px; padding: 5px; border-radius: 20px; width: 500px; background-color: rgba(230,230,230,0.5); background-repeat: no-repeat; cursor: pointer; border: none; overflow: hidden; outline: none"> Our Vision and Mission </button> </a>
			</span>
			</center>
	</div>
